...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "Al-Iman School Lafia Admin",

    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "Al-Iman",

    # Title on the brand (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_brand": "Al-Iman School",
    ...
    "welcome_sign": "Welcome to Al-Iman School Lafia",
    ...
    "search_model": ["main.CustomUser", "main.Teacher"],
    ...
    "topmenu_links": [
        ...
        {"name": "Support", "url": "https://github.com/phurhard/phurhard", "new_window": True},
    ...
    "order_with_respect_to": ["CustomUser", "Grade", "Subject", "Staff", "Student"],
    ...
    "custom_links": {
        "students": [{
            ...
            "permissions": ["books.view_students"]
        }]
    },
